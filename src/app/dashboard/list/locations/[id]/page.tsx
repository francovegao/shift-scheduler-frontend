        ...
        <div className="w-full xl:w-1/3 flex flex-col gap-4">
            <div className="bg-white p-4 rounded-md">
                ...
                <div className="mt-4 flex gap-4 flex-wrap text-xs text-white font-medium">
                    <Link className="p-3 rounded-md bg-secondary" href={`/dashboard/shifts?locationId=${id}`}>Location&apos;s Shifts</Link>
                    <Link className="p-3 rounded-md bg-complementary-one" href={`/dashboard/list/users?locationId=${id}`}>Location&apos;s Managers</Link>
                    <Link className="p-3 rounded-md bg-complementary-two" href="/">Location&apos;s Reports</Link>
                    <Link className="p-3 rounded-md bg-secondary" href="/">Location&apos;s Files</Link>
                    <Link className="p-3 rounded-md bg-complementary-one" href="/">Location&apos;s Notifications</Link>
                </div>
            </div>
