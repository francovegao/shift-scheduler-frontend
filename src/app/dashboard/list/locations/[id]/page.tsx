        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="bg-primary text-white py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              ...
              <p className="text-sm">
                {location.company.approved
                  ? "Approved: This location can post shifts"
                  : "Not Approved: This location can't post shifts"}
              </p>
        ...
        <div className="bg-surface p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-white font-medium">
            <Link
              ...
              href={`/dashboard/shifts?locationId=${id}`}
            >
              Location&apos;s Shifts
            </Link>
            <Link
              className="p-3 rounded-md bg-complementary-one"
              href={`/dashboard/list/users?locationId=${id}`}
            >
              Location&apos;s Managers
            </Link>
