        ...
        <div className="w-full xl:w-1/3 flex flex-col gap-4">
            <div className="bg-white p-4 rounded-md">
                ...
                <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                    <Link className="p-3 rounded-md bg-blue-50" href="/">Location&apos;s Shifts</Link>
                    <Link className="p-3 rounded-md bg-purple-50" href="/">Location&apos;s Files</Link>
                    <Link className="p-3 rounded-md bg-yellow-50" href="/">Location&apos;s Information</Link>
                    <Link className="p-3 rounded-md bg-pink-50" href="/">Location&apos;s Contact</Link>
                    <Link className="p-3 rounded-md bg-blue-50" href="/">Location&apos;s Reports</Link>
                </div>
            </div>
            <ShiftsGraph />
            <Announcements />
