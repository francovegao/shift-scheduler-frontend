    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="bg-blue-200 py-6 px-4 rounded-md flex-1 flex gap-4">
            <div className="w-1/3">
              <UserCircleIcon className="w-36 h-36 text-tx-muted" />
            </div>
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-surface p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              <div className="">
                ...
                <span className="text-sm text-tx-disabled">
                  Completed Shifts
                </span>
              </div>
            </div>
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-surface p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-tx-body-muted">
