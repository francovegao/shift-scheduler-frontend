  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background p-4">
      <div className="w-full max-w-sm p-8 bg-surface rounded-md shadow-2xl flex flex-col gap-6">
        ...
        <div className="text-center text-tx-body-muted relative">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t border-gray-300"></div>
          </div>
          <div className="relative inline-block px-4 bg-surface text-sm">
            Or
          </div>
        </div>
        ...
        <p className="mt-4 text-center text-tx-body-muted text-sm">
