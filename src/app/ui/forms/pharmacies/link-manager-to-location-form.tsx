    ...
    <form onSubmit={onSubmit}>
      <div className="p-4 flex flex-col gap-4">
            ...
            >
              ...
              <label className="ml-2 text-tx-tertiary">
                <p className="font-semibold">
                  {location?.name} : ({location?.legalName})
                </p>
        ...
        <span className="text-center font-medium">
          Are you sure you want to link the selected location?
        </span>
        <span className="text-center font-medium">
          Please verify all the information before linking the location
        </span>
        {errors.id?.message && (
