...
export default function BigCalendar({
  ...
  const [view, setView] = useState<View>(
    window.innerWidth < 768 ? Views.MONTH : Views.WEEK,
  );
  ...
  const eventStyleGetter = (event: any) => {
    ...
    if (
      event.shift.status === "completed" ||
      event.shift.status === "cancelled"
    ) {
              ...
              <div className="p-4 flex flex-col gap-4">
                ...
                <div className="p-4 flex flex-col gap-4 items-center text-center">
                  <p className="font-medium">
                    ...
                    {format(selectedSlotStart, "EEEE, MMMM do")}
                  </p>
                  <p className="font-medium">
...
const CustomDayEventComponent = ({ event }: any | undefined) => {
  ...
  return (
    <div>
      ...
      <p className="mb-2">
        {formatPayRate(shift.payRate)}
        {formatPayRate(shift.payRate) !== "No Data" ? " /hr" : ""}
      </p>
      {shift.status === "open" && (
        <>
          <p>Info:</p>
