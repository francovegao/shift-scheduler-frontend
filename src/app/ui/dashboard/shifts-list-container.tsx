...
export default function ShiftsListContainer({
  ...
  }, [token, searchParams, currentCompanyId, timeFilter]);
  ...
  return (
    ...
    >
      <div className="p-4 lg:p-8">
        <h1 className={`font-bold mb-4 text-xl md:text-2xl`}>{title}</h1>
        ...
        <div className="h-screen bg-surface p-1 rounded-md mb-4">
          {(role === "admin" ||
            role === "pharmacy_manager" ||
            role === "location_manager") && (
