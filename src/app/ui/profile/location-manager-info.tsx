...
export default function LocationManagerProfileInfo({
  location,
  companyName,
  token,
}: {
  ...
  return (
    ...
    //     <div className="gap-4 mt-2 bg-surface p-4 rounded-md shadow-sm">
        ...
        <div className="flex justify-between flex-wrap p-4 gap-4 bg-surface rounded-md shadow-sm">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full">
            <div className="flex flex-col">
              <label className="text-tx-body-muted">Location:</label>
              <Link
                href={`list/locations/${location?.id}`}
            ...
            <div className="flex flex-col">
              <label className="text-tx-body-muted">Company:</label>
              <p>{companyName}</p>
            </div>
          </div>
        </div>
