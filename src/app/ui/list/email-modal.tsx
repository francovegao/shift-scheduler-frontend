    ...
    <>
      <button
        ...
        className={clsx("rounded-md cursor-pointer p-2", {
          "bg-complementary-one text-white py-1 px-2.5 border-none inline-block text-center whitespace-normal break-word hover:bg-red-400 text-xs font-medium leading-tight":
      ...
      >
        ...
        {type === "request_cancellation" && "Request Cancellation"}
      </button>
